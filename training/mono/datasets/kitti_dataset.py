...
class KITTIDataset(BaseDataset):
    def __init__(self, cfg, phase, **kwargs):
        super(KITTIDataset, self).__init__(cfg=cfg, phase=phase, **kwargs)
    ...
    def get_data_for_trainval(self, idx: int):
        ...
        th = (
            352  # target size for bottom cropping, a common practice for kitti training
        )
        tw = 1216
    ...
    def process_depth(self, depth, rgb):
        ...
        new_depth[crop_h_up:crop_h_down, crop_w_left:crop_w_right] = depth[
            crop_h_up:crop_h_down, crop_w_left:crop_w_right
        ]
