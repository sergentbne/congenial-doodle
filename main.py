...
def write_to_file(filename: str, object):
    pred_depth = object.squeeze()
...
if __name__ == "__main__":
    ...
    for i in range(10000):
        write_to_file("images/" + str(i) + ".png", pred_depth)
    ...
    if (
        "prediction_normal" in output_dict
